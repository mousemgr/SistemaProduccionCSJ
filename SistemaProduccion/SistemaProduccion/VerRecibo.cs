...
namespace SistemaProduccion
{
    public partial class VerRecibo : Form
    {
        ...
        {
            CRverrecibo crystalreport = new CRverrecibo();
        ...
        public static string LoteInterno = "";

        private void btnreporte_Click(object sender, EventArgs e)
        {
            if(tbxloteinterno.Text != "")
            {
                LoteInterno = tbxloteinterno.Text;
            ...
            {
                MessageBox.Show("Favor de insertar el lote interno para generar la orden de producción ", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (tbxloteinterno.Text != "")
            {
                ...
                ReporteProduccionSlitter reporteslitter = new ReporteProduccionSlitter();
                reporteslitter.ShowDialog();
            }
            else
            {
                MessageBox.Show("Favor de insertar el lote interno para generar la orden de producción de slitter", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
